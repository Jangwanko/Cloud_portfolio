...
이 문서는 현재 검증 상태와 역사적 측정 원본을 분리합니다. OpenStack Terraform 실환경 검증은 2026-09-25에 수행했습니다. 기존 source·local candidate 성능 검증은 `2026-08-10`, 최신 public runtime 확인은 `2026-08-28`입니다. 판정 기준은 [SERVICE_REQUIREMENTS.md](SERVICE_REQUIREMENTS.md), 전체 점검 순서는 [SERVICE_PROCESS_CHECKLIST.md](SERVICE_PROCESS_CHECKLIST.md)를 사용합니다.
