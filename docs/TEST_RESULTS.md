...
| GitOps supply chain | validate → SHA image → overlay commit → Argo sync | dev-kafka CI `#76` image `66e9cc995dca`; master CI `#77` image `cab76474db1c`, tag commit `6c91f71`; demo publication은 별도 branch workflow |
